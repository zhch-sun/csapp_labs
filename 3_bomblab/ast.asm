...
0000000000400ee0 <phase_1>:
  400ee0:	48 83 ec 08          	sub    $0x8,%rsp        # why?
  400ee4:	be 00 24 40 00       	mov    $0x402400,%esi   # write to esi
...
0000000000400efc <phase_2>:
  400efc:	55                   	push   %rbp
  400efd:	53                   	push   %rbx
  400efe:	48 83 ec 28          	sub    $0x28,%rsp              # 40 bytes
  400f02:	48 89 e6             	mov    %rsp,%rsi               # save rsp in rsi
  400f05:	e8 52 05 00 00       	callq  40145c <read_six_numbers>
  400f0a:	83 3c 24 01          	cmpl   $0x1,(%rsp)             # num1==1
  400f0e:	74 20                	je     400f30 <phase_2+0x34>
  400f10:	e8 25 05 00 00       	callq  40143a <explode_bomb>
  400f15:	eb 19                	jmp    400f30 <phase_2+0x34>
  400f17:	8b 43 fc             	mov    -0x4(%rbx),%eax         
  400f1a:	01 c0                	add    %eax,%eax   
  400f1c:	39 03                	cmp    %eax,(%rbx)             # num2==8
  400f1e:	74 05                	je     400f25 <phase_2+0x29>
  400f20:	e8 15 05 00 00       	callq  40143a <explode_bomb>
  400f25:	48 83 c3 04          	add    $0x4,%rbx
  400f29:	48 39 eb             	cmp    %rbp,%rbx
  400f2c:	75 e9                	jne    400f17 <phase_2+0x1b>   # while loop!
  400f2e:	eb 0c                	jmp    400f3c <phase_2+0x40>
  400f30:	48 8d 5c 24 04       	lea    0x4(%rsp),%rbx          # num2
  400f35:	48 8d 6c 24 18       	lea    0x18(%rsp),%rbp         # after num6
...
0000000000400f43 <phase_3>:
  ...
  400f47:	48 8d 4c 24 0c       	lea    0xc(%rsp),%rcx           # 4th param, 2nd num
  400f4c:	48 8d 54 24 08       	lea    0x8(%rsp),%rdx           # 3rd param, 1st num
  400f51:	be cf 25 40 00       	mov    $0x4025cf,%esi           # "%d %d"
  400f56:	b8 00 00 00 00       	mov    $0x0,%eax
  400f5b:	e8 90 fc ff ff       	callq  400bf0 <__isoc99_sscanf@plt>
  400f60:	83 f8 01             	cmp    $0x1,%eax
  400f63:	7f 05                	jg     400f6a <phase_3+0x27>    # two number
  400f65:	e8 d0 04 00 00       	callq  40143a <explode_bomb>
  400f6a:	83 7c 24 08 07       	cmpl   $0x7,0x8(%rsp)
  400f6f:	77 3c                	ja     400fad <phase_3+0x6a>    # num1 > 7
  400f71:	8b 44 24 08          	mov    0x8(%rsp),%eax           
  400f75:	ff 24 c5 70 24 40 00 	jmpq   *0x402470(,%rax,8)       # switch   
  400f7c:	b8 cf 00 00 00       	mov    $0xcf,%eax               # num2=207
  ...
  400fbe:	3b 44 24 0c          	cmp    0xc(%rsp),%eax          # num2 == %eax
...
0000000000400fce <func4>:
  ...
  400fd8:	c1 e9 1f             	shr    $0x1f,%ecx           # logical >> 31
  400fdb:	01 c8                	add    %ecx,%eax
  400fdd:	d1 f8                	sar    %eax                 # x = (x + x >> 31) >> 1
  400fdf:	8d 0c 30             	lea    (%rax,%rsi,1),%ecx   # c = x + esi
  ...
  400ff7:	39 f9                	cmp    %edi,%ecx           # c == num good
...
000000000040100c <phase_4>:
  ...
  401033:	76 05                	jbe    40103a <phase_4+0x2e>      # num1 <= 14  
  401035:	e8 00 04 00 00       	callq  40143a <explode_bomb>
  40103a:	ba 0e 00 00 00       	mov    $0xe,%edx                 # p3 14
  40103f:	be 00 00 00 00       	mov    $0x0,%esi                 # p2 0
  401044:	8b 7c 24 08          	mov    0x8(%rsp),%edi            # p1 1st num1
  401048:	e8 81 ff ff ff       	callq  400fce <func4>
  40104d:	85 c0                	test   %eax,%eax
  40104f:	75 07                	jne    401058 <phase_4+0x4c>     # not zero explode
...
000000000040145c <read_six_numbers>:
  ...
  401460:	48 89 f2             	mov    %rsi,%rdx        # int1
  401463:	48 8d 4e 04          	lea    0x4(%rsi),%rcx   # int2
  401467:	48 8d 46 14          	lea    0x14(%rsi),%rax
  40146b:	48 89 44 24 08       	mov    %rax,0x8(%rsp)   # int6 rsi+20
  401470:	48 8d 46 10          	lea    0x10(%rsi),%rax
  401474:	48 89 04 24          	mov    %rax,(%rsp)      # int5 rsi+16
  401478:	4c 8d 4e 0c          	lea    0xc(%rsi),%r9    # int4
  40147c:	4c 8d 46 08          	lea    0x8(%rsi),%r8    # int3
